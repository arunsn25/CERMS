...
<script>
function onDeselect(){
	postServerEvent(null, null, null, "onDeselect", "deselectArgs", null);
...
<dmf:button name='deselect' cssclass="buttonLink" nlsid='MSG_DESELECT' onclick='onOk'
height='16' tooltipnlsid="MSG_DESELECT_TIP"/> <%-- runatclient='true' --%>
