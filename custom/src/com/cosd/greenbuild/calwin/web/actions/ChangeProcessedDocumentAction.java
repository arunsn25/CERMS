 ...
 * 
 * ******************************************************************************************
 * File Name: ChangeProcessedDocumentAction.java 
 * Description: 
...
public class ChangeProcessedDocumentAction implements IActionPrecondition, IActionExecution
{
			...
			ArgumentList argumentList, Context context, Component component) 
	{
		...
		//System.out.println("In action precondition ChangeProcessedDocumentAction. enable Value is : " + enable);
		return enable;
	}
	...
	{	
		String objectID = argumentList.get("objectId");
		DfLogger.debug(this,"ChangeProcessedDocumentAction Execute Called. Object selected ["+objectID+"]",null,null);
/*		try
		{
			IDfSysObject sysObj = (IDfSysObject) component.getDfSession().getObject(new DfId(objectID));
